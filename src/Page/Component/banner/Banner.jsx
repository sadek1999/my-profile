...
const Banner = () => {
    return (
        <div id="home" className='flex flex-col md:flex-row md:min-h-screen justify-center items-center gap-3  '>
            <div className="space-y-2 w-full md:w-1/2 lg:pl-20 md:text-left text-center">
